    ...
    const productsData = {
        ...
        Oil: {
            ...
            products: [
                ...
                { id: 8, name: "Virgin Coconut Oil", brand: "coconut", price: "₹250-350 per liter", image: "https://www.ishtaorganics.in/cdn/shop/files/Fireflycoconutoilin2bottlesonein500mlanotherin1lwithacoconutinsideandwhiebackgrou.jpg?v=1712694482" },
                ...
                { id: 36, name: "Flaxseed (Linseed) Oil", brand: "flaxseed", price: "₹300-500 per liter", image: "https://assets.clevelandclinic.org/transform/LargeFeatureImage/99864090-f38d-415d-b2ee-991f79170cd9/flaxseedOilSeeds-1177630653-770x553-1_jpg" },
            ...
            <div className="w-full m-0 p-0">
                ...
                <div className="flex items-center justify-between px-6 pt-4">
                    <button
                        ...
                        className="flex items-center gap-2 text-secondary hover:text-accent transition-colors font-semibold text-lg"
                    >
                        <i className="fas fa-arrow-left"></i>
                        Back to All Products
                    </button>
                    
                    {/* Mobile sidebar toggle button - positioned in the header */}
                    <button
                        className="lg:hidden text-secondary hover:text-accent transition-colors text-2xl p-3 rounded-full bg-white/40 hover:bg-white/50 shadow-xl border-2 border-secondary"
                ...
                <div className="flex m-0 p-0 mt-2">
                    {/* Sidebar */}
