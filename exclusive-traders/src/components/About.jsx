        ...
        <div className="about-content flex flex-col md:flex-row items-center gap-12">
          <div className="about-text flex-1">
            ...
            <div className="space-y-4">
              <p className="mb-4">
                Founded in 2017 as Exclusive Trader, we mastered London's luxury sector through a decade of premium hospitality operations. This experience revealed critical supply chain gaps for high-quality essentials and unnecessary intermediary costs.
              </p>
              <p className="mb-4">
